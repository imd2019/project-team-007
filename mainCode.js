...
let globalTime={day:1,start:true,hour:0,minute:0,news:false,sleepAnimation:false};
...
function preload(){
  ...
  let lowestWalk1=loadImage("img/"+charakterId+"/Poses/walk/5_lowest/walk1.png");
  let lowestWalk2=loadImage("img/"+charakterId+"/Poses/walk/5_lowest/walk2.png");
  let lowestWalk3=loadImage("img/"+charakterId+"/Poses/walk/5_lowest/walk3.png");
  let lowestWalk=[];
  ...
  let lowWalk1=loadImage("img/"+charakterId+"/Poses/walk/4_low/walk1.png");
  let lowWalk2=loadImage("img/"+charakterId+"/Poses/walk/4_low/walk2.png");
  let lowWalk3=loadImage("img/"+charakterId+"/Poses/walk/4_low/walk3.png");
  let lowWalk=[];
  lowWalk.id="LowWalk";
  ...
  let middleWalk1=loadImage("img/"+charakterId+"/Poses/walk/3_middle/walk1.png");
  let middleWalk2=loadImage("img/"+charakterId+"/Poses/walk/3_middle/walk2.png");
  let middleWalk3=loadImage("img/"+charakterId+"/Poses/walk/3_middle/walk3.png");
  let middleWalk=[];
  ...
  let highWalk1=loadImage("img/"+charakterId+"/Poses/walk/2_high/walk1.png");
  let highWalk2=loadImage("img/"+charakterId+"/Poses/walk/2_high/walk2.png");
  let highWalk3=loadImage("img/"+charakterId+"/Poses/walk/2_high/walk3.png");
  let highWalk=[];
  ...
  let victoryWalk1=loadImage("img/"+charakterId+"/Poses/walk/1_victory/walk1.png");
  let victoryWalk2=loadImage("img/"+charakterId+"/Poses/walk/1_victory/walk2.png");
  let victoryWalk3=loadImage("img/"+charakterId+"/Poses/walk/1_victory/walk3.png");
  let victoryWalk=[];
  ...
  let day1_1=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day1-1.png");
  day1_1.id="day1_1";
  let day1_2=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day1-2.png");
  day1_2.id="day1_2";
  let day2_1=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day2-1.png");
  day2_1.id="day2_1";
  let day2_2=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day2-2.png");
  day2_2.id="day2_2";
  let day3_1=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day3-1.png");
  day3_1.id="day3_1";
  let day3_2=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day3-2.png");
  day3_2.id="day3_2";
  let day4_1=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day4-1.png");
  day4_1.id="day4_1";
  let day4_2=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day4-2.png");
  day4_2.id="day4_2";
  let day5_1=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day5-1.png");
  day5_1.id="day5_1";
  let day5_2=loadImage("img/globals/news/"+bgeMode+"/newsscreen-day5-2.png");
  day5_2.id="day5_2";
  nachrichten.push(day2_1,day2_2,day3_1,day3_2,day4_1,day4_2,day5_1,day5_2);

  //<-------Chanti Activity Animation ----->
  let fridgeInteractionMiddle1=loadImage("img/"+charakterId+"/Poses/interact/3_middle/fridge/eat1.png");
  let fridgeInteractionMiddle2=loadImage("img/"+charakterId+"/Poses/interact/3_middle/fridge/eat2.png");
  let fridgeInteractionMiddle3=loadImage("img/"+charakterId+"/Poses/interact/3_middle/fridge/eat3.png");
  let fridgeInteractionMiddle4=loadImage("img/"+charakterId+"/Poses/interact/3_middle/fridge/eat4.png");
  let fridgeInteractionMiddle5=loadImage("img/Lena/Poses/interact/3_middle/fridge/drink1.png");
  let fridgeInteractionMiddle6=loadImage("img/Lena/Poses/interact/3_middle/fridge/drink2.png");
  ...
  if(charakterId=="Lena"){
    fridgeInteractionMiddle.push(fridgeInteractionMiddle1,fridgeInteractionMiddle2,fridgeInteractionMiddle3,fridgeInteractionMiddle2,fridgeInteractionMiddle4,fridgeInteractionMiddle2,fridgeInteractionMiddle1,fridgeInteractionMiddle5,fridgeInteractionMiddle6);
  }
